          ...
          <div className="min-h-[600px]">
            ...
            {activeTab === 'home' && (
              <motion.div
                ...
                className="relative overflow-hidden rounded-3xl border border-steel-200 bg-white shadow-soft"
              >
                <div className="grid lg:grid-cols-[1.08fr_0.92fr] min-h-[620px]">
                  ...
                  <div className="order-1 lg:order-2 flex items-center px-5 py-10 sm:px-8 lg:px-12">
                    ...
                    >
                      ...
                      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-steel-950 mb-5 leading-tight">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8 text-steel-700">
                        {[
                          ...
                          <motion.div
                            ...
                            className="flex items-center gap-2 rounded-lg border border-steel-200 bg-steel-50 px-3 py-2"
                          >
